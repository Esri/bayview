...
function(lang, topic, Deferred,
    ...
    return {
        ...
        runQuery: function(queryArgs) { // outFields, returnGeometry, whereClause, filterGeometry, orderByFields
          var query = this.createEsriQuery(queryArgs.query);
        ...
        createEsriQuery: function(queryArgs) {
